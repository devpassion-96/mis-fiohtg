...
@Component({
  selector: 'app-finance-leave-list',
  templateUrl: './finance-leave-list.component.html',
  styleUrls: ['./finance-leave-list.component.css']
})
export class FinanceLeaveListComponent {
